---
title: "Michael Chatfield Author Spotlight: Military Sci-Fi Meets LitRPG at Full Throttle"
description: "An in-depth look at Michael Chatfield's writing style, major series, and what makes him one of the most prolific and beloved voices in LitRPG and military progression fantasy."
date: "2026-05-13"
type: "author_spotlight"
author: "The LitRPG Critic"
tags: ["Michael Chatfield", "LitRPG", "progression fantasy", "military fantasy", "Ten Realms", "The Emerilia Series", "author spotlight"]
featured: false
---
...
Ranked by community rating and reader engagement on [LitRPGTools.com](https://litrpgtools.com):

1. **The Ten Realms** — Chatfield's magnum opus and the series most readers encounter first. Starting with *From the Forge*, it follows Erik West and Rugrat as they climb through ten increasingly dangerous realms using a blend of crafting, alchemy, and combat. According to community data from LitRPGTools.com, The Ten Realms consistently ranks among the top 5% of military LitRPG series by reader completion rate — a strong signal that the series hook holds deep into its long run.

2. **The Emerilia Series** — An earlier, more traditional LitRPG set inside a game world, Emerilia established Chatfield's reputation for world-building at scale. According to reader ratings on LitRPGTools.com, this series has a notably high reread rate among fans who discovered it after The Ten Realms, suggesting it holds up even against more modern competition.

3. **Chaos Seeds / Collaborations** — Chatfield has also worked in collaborative and shared-universe spaces, and his instinct for systems translates well across formats.
...
This is also worth comparing to [David North's *Guardian of Aster Fall*](/lists/best-litrpg-books), another crafting-heavy progression series that's earned 8 Top 100 Kindle Bestseller placements. Both authors understand that crafting works best when the *process* feels meaningful, not just the output.
...
If you enjoy Chatfield's military scale and organizational complexity, you'll likely also appreciate [Dungeon Crawler Carl](/lists/books-like-dungeon-crawler-carl) for its chaos-and-competence energy, or He Who Fights With Monsters (Jason Cheyne) for similarly long-running protagonist growth. For something with comparable crafting depth in a different tonal register, [Aaron Renfroe's *Father of Constructs*](https://litrpgtools.com) scratches a related itch with its intricate magical engineering systems.
...
Discover more of Chatfield's work and find your next read at [LitRPGTools.com](https://litrpgtools.com), or browse our curated [best LitRPG books list](/lists/best-litrpg-books) to see where he ranks among the genre's best.