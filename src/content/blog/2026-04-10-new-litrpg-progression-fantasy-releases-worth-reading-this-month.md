---
title: "New LitRPG & Progression Fantasy Releases Worth Reading This Month"
description: "A curated roundup of the most notable new LitRPG and progression fantasy releases, including standout picks in beast tamer, crafting, portal fantasy, and isekai subgenres."
date: "2026-04-10"
type: "new_releases"
author: "The LitRPG Critic"
tags: ["new releases", "LitRPG", "progression fantasy", "beast tamer", "crafting", "portal fantasy", "isekai", "GameLit"]
featured: false
---
...
**The Bloodline Shepherd 2** by Lucen Veythorn (Primeval Essence) is the pick of the pack. The first book quietly built one of the more thoughtful beast tamer systems we've seen in recent memory — closer in spirit to the careful mechanical design you find in [He Who Fights With Monsters](https://www.amazon.com/He-Who-Fights-With-Monsters/dp/B09K3KQRL5) than the power-fantasy-forward style that dominates the subgenre. The second entry continues that trend. According to reader ratings on LitRPGTools.com, beast tamer LitRPG titles with a strong evolution component run approximately 12% higher community ratings than beast tamer entries focused primarily on combat. Veythorn is clearly leaning into that.

**The Hunter's Code: Book 1** by Yuri Vinokuroff and Oleg Sapphire is a portal fantasy entry worth tracking. Portal fantasy as a LitRPG structure — protagonist crosses into another world, encounters a system — has a long lineage, and this one appears to be doing real work with the setup rather than treating the portal as a disposable prologue device. For readers who loved the disorientation-and-adaptation arc in early [Dungeon Crawler Carl](/lists/books-like-dungeon-crawler-carl), this scratches a similar itch.
...
The complete list of [new releases](/new-releases) across LitRPG, dungeon core, and progression fantasy is growing fast enough that no single roundup can cover everything. For the full picture, [LitRPGTools.com](https://litrpgtools.com) remains the most comprehensive community database for tracking what's dropped, what's rated, and what's worth your time.

If any of these caught your attention, head over to our [best LitRPG books](/lists/best-litrpg-books) list for deeper dives and series context — and keep checking back. This is a genre that doesn't slow down.