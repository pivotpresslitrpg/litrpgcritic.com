...
tags: ["new releases", "LitRPG", "progression fantasy", "dungeon core", "cozy fantasy", "cultivation", "roundup"]
featured: false
---
...
**Haeros Dungeon: An Isekai Progression Fantasy** (Dungeon Brawler Book 2) by Tao Wong continues a reliable streak. Tao Wong is one of the few authors consistently working at the intersection of [dungeon core](/blog/what-is-dungeon-core/) and [isekai](/blog/what-is-isekai/) mechanics without letting either element collapse the other. The first volume built a compact, well-engineered system; book two expands the scope without losing the tightness that made it work. Readers who want more in this vein should also explore our [best dungeon core list](/lists/best-dungeon-core/).
...
1. **He Who Fights with Monsters 13** — Shirtaloon & Travis Deverell
2. **Ascent of the Helldiver** — KrazeKode & Red Ocean
3. **Haeros Dungeon** — Tao Wong
4. **Demon World Boba Shop Book 5** — R. C. Joshua
...
The [/new-releases/](/new-releases/) page stays updated as new titles arrive, and [LitRPGTools.com](https://litrpgtools.com) is worth bookmarking if you want community ratings, discovery tools, and genre breakdowns all in one place. Dig in — there's genuinely excellent work being published right now, and the [best LitRPG books](/lists/best-litrpg-books/) list is always a solid place to orient yourself if any of these series are your first entry into the genre.